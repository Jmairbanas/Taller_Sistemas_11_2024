...
<html>
    ...
    <body>
        ...
        ?>
        <form method="POST" action="../controlador/Ctrl_EliminarEmpleado.php">
            <div class="form-group">
                <div class="form-group">
                    <label>Número Documento:</label>
                        <input type="number" name="txtCodigo" class="form-control" placeholder="Identificación del empleado">
                </div>
                <input type="submit" name="btnEliminarEmpleado" value="Eliminar" class="btn btn-dark" onclick="return alerta();">
            </div>
        </form>
