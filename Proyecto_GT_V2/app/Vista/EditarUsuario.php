                                        ...
                                        <form  method="POST" name="FormActualizarUsuario"> <!-- action="../Controlador/Ctrl_login.php"-->
                                            ...
                                            <div class="mb-3 w-75 mx-auto">
                                                ...
                                                <select name="TDocUsuario" class="form-control" id="texto-password">" Required>
                                                    ...
                                                    <option <?php if($tipoDocumento=="RC"){echo "selected";}  ?>>Registro civil</option>
                                                    <option <?php if($tipoDocumento=="TI"){echo "selected";}  ?>>Tarjeta de identidad</option>
                                                    <option <?php if($tipoDocumento=="CC"){echo "selected";}  ?>>Cédula de ciudadanía</option>
                                                    <option <?php if($tipoDocumento=="TE"){echo "selected";}  ?>>Tarjeta de extranjería</option>
                                                    <option <?php if($tipoDocumento=="CE"){echo "selected";}  ?>>Cédula de extranjería</option>
